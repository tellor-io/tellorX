...
interface ITellor{
    ...
    function getNewValueCountbyRequestId(bytes32 _tipId) external view returns(uint256);
    function getTimestampbyRequestIDandIndex(bytes32 _tipId, uint256 _index) external view returns(uint256);
    function retrieveData(bytes32 _tipId, uint256 _timestamp) external view returns(bytes memory);
    //Governance
    ...
    //Oracle
        function getReportTimestampByIndex(bytes32 _tipId, uint256 _index) external view returns(uint256);
    function getValueByTimestamp(bytes32 _tipId, uint256 _timestamp) external view returns(bytes memory);
    function getBlockNumberByTimestamp(bytes32 _tipId, uint256 _timestamp) external view returns(uint256);
    function getReporterByTimestamp(bytes32 _tipId, uint256 _timestamp) external view returns(address);
    ...
    function tipQuery(bytes32 _tipId, uint256 _tip, bytes memory _data) external;
    function submitValue(bytes32 _tipId, bytes calldata _value, uint256 _nonce, bytes memory _data) external;
    ...
    function getTimestampCountById(bytes32 _tipId) external view returns(uint256);
    function getTimestampIndexByTimestamp(bytes32 _tipId, uint256 _timestamp) external view returns(uint256);
