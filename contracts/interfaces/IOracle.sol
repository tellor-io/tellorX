...
interface IOracle{
    ...
    function tipQuery(bytes32 _id, uint256 _tip, bytes memory _data) external;
    function submitValue(bytes32 _id, bytes calldata _value, uint256 _nonce, bytes memory _data) external;
